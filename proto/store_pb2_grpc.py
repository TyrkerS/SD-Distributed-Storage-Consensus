...
class KeyValueStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.quorumRequest = channel.unary_unary(
                ...
                request_serializer=store__pb2.QuorumRequest.SerializeToString,
                response_deserializer=store__pb2.QuorumResponse.FromString,
                _registered_method=True)
        self.heartbeat = channel.unary_unary(
                '/distributedstore.KeyValueStore/heartbeat',
                request_serializer=store__pb2.Empty.SerializeToString,
                response_deserializer=store__pb2.HeartbeatResponse.FromString,
                _registered_method=True)
...
def add_KeyValueStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'quorumRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=store__pb2.QuorumRequest.FromString,
                    response_serializer=store__pb2.QuorumResponse.SerializeToString,
            ),
            'heartbeat': grpc.unary_unary_rpc_method_handler(
                    servicer.heartbeat,
                    request_deserializer=store__pb2.Empty.FromString,
                    response_serializer=store__pb2.HeartbeatResponse.SerializeToString,
            ),
...
class KeyValueStore(object):
    ...
    def quorumRequest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/distributedstore.KeyValueStore/quorumRequest',
            store__pb2.QuorumRequest.SerializeToString,
            store__pb2.QuorumResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def heartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            store__pb2.HeartbeatResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
